...
**File:** `C:\Users\user\Anthropic\baselayer-website\components\TryIt.tsx`
...
**File:** `C:\Users\user\Anthropic\baselayer-website\components\Research.tsx`
...
- Data exists from Phase 1 runs on Marks + Aarik:
  - Read `C:\Users\user\Anthropic\memory_system\docs\eval\PROVENANCE_EVAL_REPORT.md` for actual BA/PC scores
...
**File:** `C:\Users\user\Anthropic\baselayer-website\components\Hero.tsx`
...
### Current state:
- `C:\Users\user\Anthropic\buffett_memory\` — at Anthropic root
- `C:\Users\user\Anthropic\marks_memory\` — at Anthropic root
- Should be inside `C:\Users\user\Anthropic\subjects\` like all other subjects
...
### 5a. a domain-expert evaluator's data
- Location: `C:\Users\user\Anthropic\subjects\bavani_memory\`
...
- Location: `C:\Users\user\Anthropic\memory_system_v4\`
- **Needs:** re-author + re-compose with V4 pipeline
- This is PRIVATE data — output should NOT go on the website

### 5c. Paul Graham
- Location: `C:\Users\user\Anthropic\subjects\paul_graham\`
...
- Separate from website — would show Aarik's data, a domain-expert evaluator's data, or any private data
...
6. **Pipeline runs** (Paul Graham, a domain-expert evaluator compose, Aarik refresh) — separate terminal
