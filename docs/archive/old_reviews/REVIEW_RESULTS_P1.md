...
"patents":       "C:/Users/user/Anthropic/subjects/patent_memory",
"buffett":       "C:/Users/user/Anthropic/buffett_memory",
"marks":         "C:/Users/user/Anthropic/marks_memory",
OUTPUT_FILE = "C:/Users/user/Anthropic/baselayer-website/data/tensionData.ts"
```
...
```python
"C:/Users/user/Anthropic/subjects/franklin_memory/data/database/memory.db"
```
...
```python
"C:/Users/user/Anthropic/memory_system/data/database/memory.db"
"C:/Users/user/Anthropic/memory_system_v4/data/database/memory.db"
```
...
```python
("franklin", "C:/Users/user/Anthropic/subjects/franklin_memory/data/database/memory.db"),
("aarik",    "C:/Users/user/Anthropic/memory_system/data/database/memory.db"),
```
