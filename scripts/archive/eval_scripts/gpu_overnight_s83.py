...
Runs:
  ...
  C. a domain-expert evaluator phases (61 identity-tier facts)
  D. SRS (Signal Retention Score) on Paul Graham + a domain-expert evaluator briefs (Haiku API, ~$1)
  E. Compression Ratio (CR) on Paul Graham + a domain-expert evaluator (mechanical, $0)
...
def phase_a_brief_quality():
    ...
    subjects = {
        ...
        # a domain-expert evaluator excluded — private subject
    }
...
def main():
    ...
    phases = [
        ...
        # a domain-expert evaluator excluded — private subject, not for benchmarking
