...
class TestBatchStatePersistence:
    ...
    def test_load_nonexistent_returns_none(self, tmp_path):
        from scripts.batch_extract import _load_batch_state
        fake_path = tmp_path / "nonexistent.json"
        with patch("scripts.batch_extract.BATCH_STATE_FILE", fake_path):
            result = _load_batch_state()
        assert result is None

    def test_save_creates_file(self, tmp_path):
        from scripts.batch_extract import _save_batch_state
        state_file = tmp_path / "data" / "database" / "batch_state.json"
        with patch("scripts.batch_extract.BATCH_STATE_FILE", state_file):
    ...
    def test_roundtrip(self, tmp_path):
        from scripts.batch_extract import _load_batch_state, _save_batch_state
...
class TestBuildConvText:
    ...
    def test_basic_building(self):
        from scripts.batch_extract import _build_conv_text
        messages = [
