...
class TestNormalizeCategory:
    ...
    def test_canonical_categories(self):
        from scripts.extract_facts import normalize_category
...
class TestNormalizeSubject:
    ...
    def _clear_caches(self):
        ...
        from scripts.extract_facts import _get_entity_map, _get_user_names
    ...
    def test_user_variants(self):
        from scripts.extract_facts import normalize_subject
        with patch("scripts.extract_facts._get_user_names", return_value=set()):
            with patch("scripts.extract_facts._get_entity_map", return_value={}):
    ...
    def test_entity_map_resolution(self):
        ...
        with patch("scripts.extract_facts._get_user_names", return_value=set()):
            with patch("scripts.extract_facts._get_entity_map", return_value=mock_map):
                assert normalize_subject("John") == "colleague:John"

    def test_user_name_detected(self):
        from scripts.extract_facts import normalize_subject
        with patch("scripts.extract_facts._get_user_names", return_value={"alice"}):
            with patch("scripts.extract_facts._get_entity_map", return_value={}):
...
class TestNormalizeIntent:
    ...
    def test_does_variants(self):
        from scripts.extract_facts import normalize_intent
...
class TestNormalizeTemporal:
    ...
    def test_current_variants(self):
        from scripts.extract_facts import normalize_temporal
...
class TestNormalizeFactClass:
    ...
    def test_event_variants(self):
        from scripts.extract_facts import normalize_fact_class
...
class TestNormalizeKnowledgeTier:
    ...
    def test_identity_variants(self):
        from scripts.extract_facts import normalize_knowledge_tier
...
class TestNormalizePredicate:
    ...
    def test_canonical_predicates_pass_through(self):
        from scripts.extract_facts import normalize_predicate
        from scripts.config import CONSTRAINED_PREDICATES
...
class TestReconstructFactText:
    ...
    def test_basic_reconstruction(self):
        from scripts.extract_facts import reconstruct_fact_text
...
class TestGetExtractionCaps:
    ...
    def test_short_conversation(self):
        from scripts.extract_facts import _get_extraction_caps
...
class TestComputeConfidence:
    ...
    def test_high_confidence_user_does(self):
        from scripts.extract_facts import compute_confidence
...
class TestPredicateToIntent:
    ...
    def test_learning_predicates(self):
        from scripts.extract_facts import _predicate_to_intent
