...
class TestDetectProvider:
    ...
    def test_claude_models(self):
        from scripts.llm_provider import detect_provider
...
class TestResolveModel:
    ...
    def test_explicit_model_takes_priority(self):
        from scripts.llm_provider import _resolve_model
    ...
    def test_all_valid_roles(self):
        from scripts.llm_provider import _resolve_model
        from scripts.config import LLM_PROVIDER_CONFIG
...
class TestEstimateCost:
    ...
    def test_known_model_haiku(self):
        from scripts.llm_provider import estimate_cost
...
class TestGetProviderInfo:
    ...
    def test_anthropic_provider_info(self):
        from scripts.llm_provider import get_provider_info
...
class TestPricing:
    ...
    def test_all_entries_have_input_and_output(self):
        from scripts.llm_provider import PRICING
